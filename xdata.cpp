/*
** Astrolog (Version 6.00) File: xdata.cpp
**
...
GS gs = {
  ...
  fTrue, fTrue, fFalse, fTrue, fFalse, fFalse, fFalse, DEFAULTX, DEFAULTY,
#ifdef WIN
  -10,
#else
  0,
#endif
  200, 0, 0, 0, 0.0, BITMAPMODE, 0, 8.5, 11.0, NULL, oCore, 600, 1111
#ifdef PCG
...
WI wi = {
  ...
  fFalse, fTrue, fTrue, fFalse, fTrue, fFalse, kBlack, 1, 1000};
